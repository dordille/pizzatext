...
window.require.register("views/templates/gif", function(exports, require, module) {
  module.exports = function anonymous(locals) {
  var buf = [];
  var locals_ = (locals || {}),imgsrc = locals_.imgsrc;buf.push("<a href=\"#\" title=\"Back\" class=\"back\">Back</a><img" + (jade.attrs({ 'src':(imgsrc), "class": [('gif')] }, {"src":true})) + "/><a href=\"#\" title=\"Share on Tumblr\" class=\"tumblr_share\">Share on Tumblr</a>");;return buf.join("");
  };
});
