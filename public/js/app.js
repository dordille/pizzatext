...
window.require.register("views/templates/controls", function(exports, require, module) {
  ...
  with (locals || {}) {
  var interp;
  buf.push('<div class="row"><a data-action="rotateX" class="pizza_button">Rotate X</a><a data-action="rotateY" class="pizza_button">Rotate Y</a><a data-action="rotateZ" class="pizza_button">Rotate Z</a></div><div class="row"><a data-action="bounceX" class="pizza_button">Bounce X</a><a data-action="bounceY" class="pizza_button">Bounce Y</a><a data-action="bounceZ" class="pizza_button">Bounce Z</a></div><div class="row textures">');
  // iterate model.textures
  ;(function(){
    if ('number' == typeof model.textures.length) {

      for (var $index = 0, $$l = model.textures.length; $index < $$l; $index++) {
        var texture = model.textures[$index];

  buf.push('<a');
  buf.push(attrs({ 'data-action':("setTexture"), 'data-texture':(texture), "class": ('pizza_texture') }, {"data-action":true,"data-texture":true}));
  buf.push('><img');
  buf.push(attrs({ 'src':(texture) }, {"src":true}));
  buf.push('/></a>');
      }

    } else {
      var $$l = 0;
      for (var $index in model.textures) {
        $$l++;      var texture = model.textures[$index];
  ...
  buf.push('</div><div class="row text"><input');
  buf.push(attrs({ 'type':("text"), 'value':(model.get('text')), "class": ("text") }, {"type":true,"class":true,"value":true}));
  buf.push('/></div><div class="row last"><a data-action="bake" class="bake">Bake</a></div><div class="right"></div><div class="bottom"></div>');
  }
  return buf.join("");
  };
});
window.require.register("views/templates/gif", function(exports, require, module) {
  ...
  with (locals || {}) {
  var interp;
  buf.push('<a href="#" title="Back" class="back">Back</a><img');
  buf.push(attrs({ 'src':(imgsrc), "class": ('gif') }, {"src":true}));
  buf.push('/><a href="#" title="Share on Tumblr" class="tumblr_share">Share on Tumblr</a>');
  }
  return buf.join("");
  };
});
...
window.require.register("views/templates/scene", function(exports, require, module) {
  ...
  with (locals || {}) {
  var interp;
  buf.push('<div class="front"><div class="canvas"></div></div><div class="back"><div class="progress"><div class="pizza"></div><div class="percent"></div></div><div class="gifs"></div></div>');
  }
  return buf.join("");
  };
});
